      ...
      max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I am
            <span className="text-violet-300"> Ufuk Enes KURT</span> UEKAPPS</h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I have extensive experience in software development,<br className="sm:block hidden" />information technology and cyber security.
          </p>
        </div>
      </div>
      <ComputersCanvas />
